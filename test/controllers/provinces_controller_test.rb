...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference("Province.count") do
      post provinces_url, params: { province: { created_by: @province.created_by, created_by_name: @province.created_by_name, name: @province.name, updated_by: @province.updated_by, updated_by_name: @province.updated_by_name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { created_by: @province.created_by, created_by_name: @province.created_by_name, name: @province.name, updated_by: @province.updated_by, updated_by_name: @province.updated_by_name } }
